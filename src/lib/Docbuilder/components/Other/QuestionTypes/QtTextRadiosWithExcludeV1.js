...
//
// Form display for questions of type text_radios_with_exclude_v1.
// -------------------------------------------------------------------------
// Typically rendered inside ./Question (which is then rendered
// inside ./Subsection).
//

export default function QtTextRadiosWithExcludeV1({
  ...
  const assembleAnswerPayload = (question, selection, otherText, validate) => {
...
QtTextRadiosWithExcludeV1.propTypes = {
  ...
  storedAnswer: PropTypes.shape(docbuilderAnswerByQuestionTypeShapes.text_radios_with_exclude_v1),
